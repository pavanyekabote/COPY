...
#### Thought and path for its creation
   ...
   Later this my brain one day suddenly signalled me ***Why not upgrade this simple messaging application to be capable of transfering files between two nodes..!At the end File is also data.*** Then I started to learn Networking concepts of java and upgraded its capabilities to transfer files too. 
